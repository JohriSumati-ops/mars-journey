  ...
  return (
    <>
      ...
      <style>{`
        ...
        .glass-pill:hover { border-color: rgba(224,90,30,0.38); }
        .mp-btn {
          background: none;
          border: none;
          cursor: pointer;
      ...
      <div className="music-player-outer">
        <div
          ...
          style={{ width: expanded ? 300 : 52, height: expanded ? 'auto' : 52 }}
        >
            ...
            <div style={{ padding: '14px 16px' }}>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  ...
                  <span style={{
                    ...
                    color: `${track.color}cc`, textTransform: 'uppercase',
                  }}>
                    AMBIENT
                  </span>
                </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  {muted
                    ...
                    : <svg width="13" height="13" viewBox="0 0 24 24" fill="none">
                        ...
                        <path d="M15.54 8.46a5 5 0 0 1 0 7.07"
                          stroke={track.color} strokeWidth="1.5" strokeLinecap="round"/>
                        <path d="M19.07 4.93a10 10 0 0 1 0 14.14"
                          stroke={`${track.color}70`} strokeWidth="1.5" strokeLinecap="round"/>
                      </svg>
                  }
                </button>
                <input
                ...
                <span style={{
                  ...
                  color: 'rgba(255,255,255,0.18)', minWidth: 24,
                }}>
